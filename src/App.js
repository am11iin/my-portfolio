...
const HeroSection = () => {
  ...
  const downloadCV = () => {
    ...
    link.href = '/amine_cv.pdf';
    link.download = 'amine - CV.pdf';
  ...
  const downloadResume = () => {
    const link = document.createElement('a');
    link.href = '/amine - Resume.pdf';
    link.download = 'amine - Resume.pdf';
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
  };
          ...
          <div className="flex-1 space-y-8 text-center lg:text-left">
            <div className="space-y-6">
              ...
              <h2 className="text-lg md:text-xl lg:text-2xl text-slate-400 font-light leading-relaxed">
                Front-End Developer & Computer Vision Master Student
              </h2>
            </div>
            
            <p className="text-slate-300 text-base md:text-lg lg:text-xl leading-relaxed max-w-2xl mx-auto lg:mx-0">
              building interactive web applications with React and modern web technologies, while exploring computer vision projects and AI applications in Python.
            </p>
            ...
            <div className="flex space-x-4 justify-center lg:justify-start transform -translate-y-4">
              {[
                { icon: LinkedinIcon, href: 'https://www.linkedin.com/in/mohamed-amine-sellami-19686b350/', label: 'LinkedIn' },
                { icon: GithubIcon, href: 'https://github.com/am11iin', label: 'GitHub' },
                { icon: MailIcon, href: 'mailto:mohamedsellami479@gmail.com', label: 'Email' }
              ].map((social) => (
                <a
                  key={social.label}
                  href={social.href}
                ...
                <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-emerald-400 via-teal-400 to-cyan-400 p-1.5">
                  <div className="w-full h-full rounded-full bg-slate-900 flex items-center justify-center">
                      <img 
                        src="/amine3.jpg" 
                        alt="Profile" 
                         className="w-[calc(100%-12px)] h-[calc(100%-12px)] rounded-full object-cover object-[10%_50%] shadow-xl" 
                      />
    ...
    <section className="pt-20 pb-20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 w-full">
      <div className="w-full max-w-6xl mx-auto px-4 md:px-6">
        ...
        <p className="text-lg md:text-xl leading-relaxed">
          I’m a Front-End Developer and Computer Vision Master Student passionate about creating clean, dynamic, and user-friendly interfaces. 
          My work combines modern web technologies with AI concepts to build solutions that are both functional and intelligent.
          From interactive web apps to practical computer vision experiments, I focus on writing maintainable code, solving real problems, 
          and designing experiences that feel intuitive and efficient.
        </p>
        ...
        <p className="text-lg md:text-xl leading-relaxed">
          ...
          I enjoy transforming ideas into functional, visually engaging solutions.
        </p>

        <p className="text-lg md:text-xl leading-relaxed">
          Whether developing front-end interfaces or exploring computer vision models, I aim to create technology that is performant, scalable, 
          and centered around user experience.
        </p>
      </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-slate-700/50">
              {[
                { number: '5+', label: 'Projects Delivered', color: 'from-emerald-400 to-teal-400' },
                { number: '2+', label: 'Years Experience', color: 'from-teal-400 to-cyan-400' },
                { number: '4+', label: 'Tech Stacks', color: 'from-cyan-400 to-blue-400' }
              ].map((stat) => (
...
const ServicesSection = () => {
  const services = [
  {
    ...
    description: 'Building modern and responsive websites using React and clean front-end practices.',
    features: ['React Development', 'Responsive UI', 'Modern JavaScript', 'Clean Code'],
    color: 'from-blue-500 to-cyan-500'
  },
  {
    icon: '🎨',
    title: 'UI/UX & Front-End Design',
    description: 'Designing clean, intuitive, and user-centered interfaces for web applications.',
    features: ['User Interface Design', 'Wireframing', 'Responsive Layouts', 'Interactive Prototypes'],
    color: 'from-purple-500 to-pink-500'
  },
  {
    icon: '🤖',
    title: 'Computer Vision Basics',
    description: 'Building beginner-friendly computer vision projects and experimenting with Python and OpenCV.',
    features: ['OpenCV Basics', 'Image Processing', 'ML Experiments', 'Python Scripts'],
    color: 'from-green-500 to-emerald-500'
  },
  {
    icon: '🚀',
    title: 'Landing Pages & Portfolio',
    description: 'Creating fast, polished landing pages and personal portfolios for individuals and small projects.',
    features: ['Modern UI', 'Fast Performance', 'Responsive Pages', 'SEO-Friendly'],
      ...
      <div className="w-full max-w-6xl mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 text-lg lg:text-xl max-w-3xl mx-auto leading-relaxed">
            Creating development solutions that match your exact requirements
          </p>
        </div>
...
const SkillsSection = () => {
  const skills = [
    ...
    { name: 'React', level: 60, color: 'from-cyan-400 to-blue-500' },
    { name: 'Java', level: 55, color: 'from-orange-400 to-red-500' },
  ];
...
const ProjectsSection = () => {
  const projects = [
   {
  title: 'TAKWINI E-learning Platform',
  description: 'Responsive e-learning platform with modern UI, user management, course tracking, and notifications. Built RESTful APIs with FastAPI and PostgreSQL. Collaborative development via Git & GitHub.',
  tech: ['Python', 'FastAPI', 'PostgreSQL', 'JavaScript', 'React', 'Tailwind CSS', 'Git'],
  icon: '🎓',
  color: 'from-green-500 to-emerald-500',
  link: 'https://github.com/am11iin/pfe-frontend'},
  
  
   {
  title: 'Hiking Journal',
  description: 'Personal adventure journal platform with modern UI and smooth animations. Built with React, Vite, Tailwind CSS, and Framer Motion.',
  tech: ['JavaScript', 'React', 'Vite', 'Tailwind CSS', 'Framer Motion'],
  icon: '🏕️',
  color: 'from-indigo-500 to-purple-500',
  link: 'https://amine-hiking-journal.netlify.app/'
   },

  {
    title: 'To-Do List App',
    description: 'A basic web application to manage daily tasks with add, delete, and mark-as-done functionality.',
    tech: ['JavaScript', 'HTML', 'CSS'],
    icon: '✅',
    color: 'from-purple-500 to-pink-500',
    link: 'https://am11iin.github.io/todoList-app/'       
  },
  {
    title: 'Calculator App',
    description: 'A simple calculator web app performing basic arithmetic operations.',
    tech: ['JavaScript', 'HTML', 'CSS'],
    icon: '🧮',
    color: 'from-orange-500 to-red-500',
    link: 'https://am11iin.github.io/calculator-js/'
  },
  {
    title: 'Weather App',
    description: 'A beginner-friendly app that fetches weather data from an API and displays it dynamically.',
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 bg-slate-800/50 border-2 border-slate-700 text-slate-300 py-3 rounded-2xl font-semibold text-sm hover:border-emerald-400 hover:text-emerald-400 hover:bg-emerald-400/5 transition-all duration-500 group-hover:scale-105"
              >
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (typeof window !== 'undefined' && window.emailjs) {
        window.emailjs.init('dTtVGCNwX9Sgh0xZ_');
      ...
      <div className="w-full max-w-6xl mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="space-y-6">
              {[
                { icon: MailIcon, label: 'Email', value: 'Mohamedsellami479@gmail.com' },
                { icon: PhoneIcon, label: 'Phone', value: '+213 784129273' },
                { icon: MapPinIcon, label: 'Location', value: 'Algiers, Algeria.' }
              ].map((contact) => (
...
const Portfolio = () => {
  ...
  useEffect(() => {
    ...
    script.onload = () => {
      ...
      if (window.emailjs) {
        window.emailjs.init('service_x7t5fjk');
      }
    };
        ...
        <div className="w-full max-w-6xl mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-slate-400">
              © 2025 Amine Sellami. Built with care and creativity.
